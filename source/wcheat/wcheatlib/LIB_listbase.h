...
WCHEAT_INLINE bool LIB_listbase_is_empty(const ListBase *listbase);
/** Checks if a ListBase contains exactly one Link. */
WCHEAT_INLINE bool LIB_listbase_is_single(const ListBase *listbase);

/** Clears all Links from a ListBase, resetting it to an empty state. */
WCHEAT_INLINE void LIB_listbase_clear(ListBase *listbase);
WCHEAT_INLINE void LIB_listbase_swap(ListBase *lb1, ListBase *lb2);
